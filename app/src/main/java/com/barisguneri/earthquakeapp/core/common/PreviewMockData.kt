...
object PreviewMockData {
    val earthquakeInfoModel = listOf(
        EarthquakeInfo(
            id = "ZwBwDlDghVOd1",
            location = Location(lat = 39.2065, long = 28.1677),
            magnitude = 1.8,
            date = "2025.08.21",
            dateTime = "2025.08.21 16:27:53",
            depthInfo = "11.1 km",
            title = "YAYLACIK-SINDIRGI (BALIKESIR)"
        ),
        EarthquakeInfo(
            id = "x8BJjS2jR2K9j",
            location = Location(lat = 38.3732, long = 38.7665),
            magnitude = 2.3,
            date = "2025.08.21",
            dateTime = "2025.08.21 16:25:28",
            depthInfo = "6.2 km",
            title = "TEPEKOY-KALE (MALATYA)"
        ),
        EarthquakeInfo(
            id = "64VmLJRdaFclM",
            location = Location(lat = 39.2412, long = 28.1048),
            magnitude = 2.1,
            date = "2025.08.21",
            dateTime = "2025.08.21 16:16:10",
            depthInfo = "10.2 km",
            title = "KOZLU-SINDIRGI (BALIKESIR)"
        ),
        EarthquakeInfo(
            id = "eA3yZa95qljbO",
            location = Location(lat = 39.223, long = 28.173),
            magnitude = 2.6,
            date = "2025.08.21",
            dateTime = "2025.08.21 16:12:01",
            depthInfo = "8.3 km",
            title = "YAYLACIK-SINDIRGI (BALIKESIR)"
        ),
        EarthquakeInfo(
            id = "eMXIz43nkH1mc",
            location = Location(lat = 39.2435, long = 28.0605),
            magnitude = 1.6,
            date = "2025.08.21",
            dateTime = "2025.08.21 16:02:25",
            depthInfo = "13.6 km",
    ...
    val mockEarthquakeInfo = EarthquakeDetail(
        ...
        airports = listOf(
            Airports(
                code = "BZI",
                coordinates = Location(lat = 39.6193, long = 27.926),
                distance = 50379.27,
                name = "Balıkesir Merkez Havalimanı"
            ),
            Airports(
                code = "EDO",
                coordinates = Location(lat = 39.5546, long = 27.0138),
                distance = 106460.29,
                name = "Balıkesir Koca Seyit Havalimanı"
            ),
            Airports(
                code = "BDM",
                coordinates = Location(lat = 40.318, long = 27.9777),
                distance = 124655.68,
